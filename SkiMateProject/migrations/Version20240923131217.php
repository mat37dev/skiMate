 ...
 */
final class Version20240923131217 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE statistics (id INT AUTO_INCREMENT NOT NULL, total_distance DOUBLE PRECISION NOT NULL, total_hours DATETIME NOT NULL, total_elevation DOUBLE PRECISION NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
